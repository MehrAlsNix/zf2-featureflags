...
class ToggleHelperFactoryTest extends AbstractHttpControllerTestCase
{
    /**
    ...
    {
        $this->factory = new ToggleHelperFactory();
    ...
    public function createService()
    {
        ...
        $this->assertInstanceOf('MehrAlsNix\FeatureToggle\View\Helper\FeatureToggle', $this->factory->createService($this->services));
    }
}
